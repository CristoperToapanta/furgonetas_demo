...
const NOMBRES_PASAJEROS_URL = initConfig.host + "/pasajero/nombres-pasajeros";
...
export function nombres_pasajeros(){
    return axios.get(`${NOMBRES_PASAJEROS_URL}`, {timeout:50000})
        .then(r=> r)
        .catch(err => err)
}
