...
const pasajerosController = {
    ...
    insertarPasajero: async function (req, res) {
        ...
        await pasajeroConsultas.insertPasajero([
            req.body.id_representante, req.body.cedula_pasajero, req.body.nombre_pasajero, 
            req.body.direccion_pasajero, req.body.edad_pasajero, req.body.institucion_pasajero, 
            req.body.direccion_institucion, req.body.genero_pasajero
        ]).then((resp) => {
